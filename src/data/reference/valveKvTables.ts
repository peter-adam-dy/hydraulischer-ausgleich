...
export const valveTypes: ValveType[] = [
  // Source: store.danfoss.com product pages (official Danfoss data)
  {
    id: 'danfoss_ra_n',
    name: 'RA-N',
  ...
  // Source: Danfoss presetting insert datasheets, Kv range 0.05–0.44 (DN15, xp=2K)
  {
    id: 'danfoss_rav',
    name: 'RAV (mit Voreinstelleinsatz)',
    manufacturer: 'Danfoss',
    sizes: [
      {
        dn: 15,
  ...
  {
    id: 'danfoss_ravl',
    name: 'RAVL (mit Voreinstelleinsatz)',
    manufacturer: 'Danfoss',
    sizes: [
      {
        dn: 15,
